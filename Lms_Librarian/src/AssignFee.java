...
public class AssignFee extends javax.swing.JFrame {
    ...
    private void initComponents() {
		...
		jButton1.addActionListener(new ActionListener() {
			...
			int i=CustomerDao.update(phoneno,fee);
			if(i>0){
				JOptionPane.showMessageDialog(AssignFee.this,"User successfully penalized!");
				LibnPage.main(new String[]{});
				dispose();
				
			}else{
				JOptionPane.showMessageDialog(AssignFee.this,"Sorry, unable to penalize!");
			}
			}
		});
